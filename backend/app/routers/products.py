...
def create_product(
    ...
    db: Session = Depends(get_db),
    current_user: models.User = Depends(has_permission("product:create")),
):
...
def update_product(
    ...
    product_in: schemas.ProductCreate,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(has_permission("product:update")),
):
...
def delete_product(
    product_id: UUID,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(has_permission("product:delete")),
):
