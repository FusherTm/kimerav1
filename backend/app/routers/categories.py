...
def create_category(
    ...
    db: Session = Depends(get_db),
    current_user: models.User = Depends(has_permission("category:create")),
):
...
def update_category(
    ...
    category_in: schemas.CategoryCreate,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(has_permission("category:update")),
):
...
def delete_category(
    category_id: UUID,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(has_permission("category:delete")),
):
